<script lang="ts">
  import { PayForPlaySyncState } from '../pay-for-play-sync.svelte';
  
  const state = new PayForPlaySyncState();
</script>

<div>
  <div class="flex justify-between items-center mb-6">
    <div>
      <h2 class="text-xl font-bold">Pay for Play Items</h2>
      <p class="text-gray-500 text-sm">Sync Notion Pay for Play Items to Loyverse</p>
    </div>
            ...
            <tr>
              <td colspan="5" class="p-12 text-center text-gray-400">
                <div class="flex flex-col items-center gap-2">
                  ...
                  <p>No pay for play items found matching filters.</p>
                </div>
              </td>
            </tr>
          {/each}
