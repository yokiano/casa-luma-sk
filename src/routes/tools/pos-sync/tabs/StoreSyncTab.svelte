<script lang="ts">
  import { StoreSyncState } from '../store-sync.svelte';
  
  const state = new StoreSyncState();
</script>

<div>
  <div class="flex justify-between items-center mb-6">
    <div>
      <h2 class="text-xl font-bold">Store Items</h2>
      <p class="text-gray-500 text-sm">Sync Notion Store Items to Loyverse</p>
    </div>
            ...
            <tr>
              <td colspan="5" class="p-12 text-center text-gray-400">
                <div class="flex flex-col items-center gap-2">
                  ...
                  <p>No store items found matching filters.</p>
                </div>
              </td>
            </tr>
          {/each}
