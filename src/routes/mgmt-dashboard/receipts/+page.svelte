...
<section class="space-y-6">
  <header class="space-y-2">
    <p class="text-sm font-bold uppercase tracking-[0.22em] text-[#7a6550]/55">Receipt operations</p>
    <h1 class="text-3xl font-semibold tracking-tight text-[#2c2925]">Receipts</h1>
  ...
  <aside class="rounded-3xl border border-sky-200 bg-sky-50 p-4 text-sm leading-6 text-sky-950 shadow-sm">
    ...
    <p class="mt-1">Receipt webhook replay is a manager-only recovery tool for stored events. It is not part of the normal receipt workflow, defaults to a dry-run, and requires explicit confirmation plus deployment enablement for live use. Agents: read <code>docs/receipts/replay.md</code> before using it.</p>
  </aside>
