<script lang="ts">
  ...
  let { receipts = [], analytics = null, groupBy = 'day' }: Props = $props();
...
<section class="space-y-6">
  ...
  <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
    <div class="flex flex-col justify-center min-h-28 rounded-3xl border border-[#dfd2c5] bg-white p-4 shadow-sm">
    ...
    <div class="flex flex-col justify-center min-h-28 rounded-3xl border border-[#dfd2c5] bg-white p-4 shadow-sm lg:col-span-2 xl:col-span-1">
