...
export interface MenuItemsResponse extends WithOptional<Omit<DatabaseObjectResponse, 'properties'>, 'title'| 'description'| 'is_inline'| 'url'| 'public_url'> {
  properties: {
    ...
    "Category": Omit<SelectPropertyItemObjectResponse, 'select'> & { select: { id: StringRequest, name: 'House Smoothies', color: 'pink' } | { id: StringRequest, name: 'Coffee & Friends', color: 'brown' } | { id: StringRequest, name: 'Fresh Cold-Pressed Juices', color: 'green' } | { id: StringRequest, name: 'Soft Drinks', color: 'blue' } | { id: StringRequest, name: 'Proper Sandwiches', color: 'orange' } | { id: StringRequest, name: 'Crafted Croissants', color: 'yellow' } | { id: StringRequest, name: 'Open Toasts', color: 'yellow' } | { id: StringRequest, name: 'Personal Pizzas', color: 'red' } | { id: StringRequest, name: 'Fresh But Not Boring', color: 'green' } | { id: StringRequest, name: 'Healthy Treats', color: 'orange' } | { id: StringRequest, name: 'Desserts', color: 'pink' } | { id: StringRequest, name: 'Kids Pizza', color: 'red' } | { id: StringRequest, name: 'Kids Favorites', color: 'yellow' } | { id: StringRequest, name: 'Kids Small Plates', color: 'blue' } | { id: StringRequest, name: 'Kids Beverage', color: 'blue' } | { id: StringRequest, name: 'Build Your Breakfast', color: 'default' } | { id: StringRequest, name: 'Comfort Food', color: 'gray' }},
