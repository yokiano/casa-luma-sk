...
export interface CompanyLedgerResponse extends WithOptional<Omit<DatabaseObjectResponse, 'properties'>, 'title'| 'description'| 'is_inline'| 'url'| 'public_url'> {
  properties: {
    "Type": Omit<SelectPropertyItemObjectResponse, 'select'> & { select: { id: StringRequest, name: 'Bank Transfer Expense', color: 'purple' } | { id: StringRequest, name: 'Credit Card Income', color: 'green' } | { id: StringRequest, name: 'Scan Income', color: 'green' } | { id: StringRequest, name: 'Bank Deposit Income', color: 'green' } | { id: StringRequest, name: 'Expense from Backup', color: 'pink' } | { id: StringRequest, name: 'Scan Expense', color: 'red' } | { id: StringRequest, name: 'Register Expense', color: 'orange' } | { id: StringRequest, name: 'Refund', color: 'yellow' } | { id: StringRequest, name: 'Owner Draw', color: 'blue' } | { id: StringRequest, name: 'Owner Contribution', color: 'purple' } | { id: StringRequest, name: 'Dividend', color: 'orange' } | { id: StringRequest, name: 'Expense', color: 'brown' }},
