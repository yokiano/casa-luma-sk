...
export interface JobOpeningsResponse extends WithOptional<Omit<DatabaseObjectResponse, 'properties'>, 'title'| 'description'| 'is_inline'| 'url'| 'public_url'> {
  properties: {
    ...
    "Required Skills": Omit<MultiSelectPropertyItemObjectResponse, 'multi_select'> & { multi_select: [{ id: StringRequest, name: 'Project Management', color: 'purple' } | { id: StringRequest, name: 'Leadership', color: 'red' } | { id: StringRequest, name: 'Problem Solving', color: 'green' } | { id: StringRequest, name: 'Good English', color: 'yellow' } | { id: StringRequest, name: 'Handyman', color: 'default' } | { id: StringRequest, name: 'Coffee Machine', color: 'pink' } | { id: StringRequest, name: 'Cashier', color: 'blue' } | { id: StringRequest, name: 'Customer Service', color: 'brown' } | { id: StringRequest, name: 'Hygiene', color: 'orange' } | { id: StringRequest, name: 'Kitchen Tasks', color: 'gray' } | { id: StringRequest, name: 'Western Cooking', color: 'blue' } | { id: StringRequest, name: 'Team Player', color: 'brown' } | { id: StringRequest, name: 'Basic English', color: 'purple' }]},
