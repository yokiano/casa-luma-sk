...
export type FinancialLedgerPropertiesPatch = {
  type?: FinancialLedgerResponse['properties']['Type']['select']['name']
  ...
  department?: FinancialLedgerResponse['properties']['Department']['select']['name']
  invoiceReceipt?: TypeFromRecord<UpdatePageBodyParameters['properties'], { type?: 'files' }>['files']
  approvedBy?: FinancialLedgerResponse['properties']['Approved By']['select']['name']
  paymentMethod?: FinancialLedgerResponse['properties']['Payment Method']['select']['name']
...
export class FinancialLedgerPatchDTO {
