...
export class StoreItemsResponseDTO {
  ...
  id: StoreItemsResponse['id']
  title: StoreItemsResponse['title']
  description: StoreItemsResponse['description']
  parent: StoreItemsResponse['parent']
  createdBy: StoreItemsResponse['created_by']
  lastEditedBy: StoreItemsResponse['last_edited_by']
  createdTime: StoreItemsResponse['created_time']
  lastEditedTime: StoreItemsResponse['last_edited_time']
  isInline: StoreItemsResponse['is_inline']
  archived: StoreItemsResponse['archived']
  url: StoreItemsResponse['url']
  publicUrl: StoreItemsResponse['public_url']
  properties: StoreItemsPropertiesResponseDTO

  constructor(res: StoreItemsResponse) {
    this.__data = res
    this.id = res.id
    ...
    this.properties = new StoreItemsPropertiesResponseDTO(res.properties)
  }
...
export class StoreItemsPropertiesResponseDTO {
  __props: StoreItemsResponse['properties']
  __data

  constructor(props: StoreItemsResponse['properties']) {
    this.__props = props
    this.__data = {
      ...
      expiryDate: this.__props['Expiry Date'],
  ...
  get expiryDate() {
    return this.__props['Expiry Date']?.date
  }
