...
export class LegacyBillPaymentSlipParser implements ExpenseParser {
  id = 'kbank-bill-payment-legacy';
  name = 'K-Bank Bill Payment Slip (Legacy)';
  ...
  validate(rawText: string): boolean {
    ...
    const hasThaiKeyword = 
      ...
      text.includes('จ า ย บ ล ส า เ ร จ') ||
      text.includes('จ า ย บ ล ส า เร จ');
